...
const categories = [
  ...
  { name: "CE", desc: "Kamion me rimorkio", age: "21+", duration: "10 ditë", price: "300€", icon: Truck, image: truckCeImg },
  { name: "D", desc: "Autobus (mbi 8 udhëtarë)", age: "24+", duration: "21 ditë", price: "300€", icon: Bus, image: busDImg },
];
